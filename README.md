...
Tools like [mise](https://github.com/jdx/mise) have grown into full-fledged build systems, so if you wish for a simple, quick, no-config tool-versions manager, you would love this. 
